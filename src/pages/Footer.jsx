        ...
        <div className="flex flex-col lg:flex-row lg:justify-between">
          <div className="mb-8 lg:mb-0">
            <div className="flex flex-col lg:flex-row lg:gap-5">
              <Link to={'/about'} className="mb-2 font-bodyFont hover:text-primary lg:mb-0">About Us</Link>
              <Link to={'/contact'} className="mb-2 font-bodyFont hover:text-primary lg:mb-0">Contact Us</Link>
              <Link to={''} className="mb-2 font-bodyFont hover:text-primary lg:mb-0">Join Us</Link>
              <Link to={'/portofolio'} className="mb-2 font-bodyFont hover:text-primary lg:mb-0">Portfolio</Link>
              <Link to={''} className="mb-2 hover:text-primary font-bodyFont lg:mb-0">Privacy Policy</Link>
              <Link to={''} className="mb-2 hover:text-primary font-bodyFont lg:mb-0">Terms</Link>
            </div>
          ...
          <div className="">
            <p className="mb-2 flex font-bodyFont text-xl hover:text-red-500 lg:mb-0">
              <FaHome className="text-2xl my-2 mr-2" />
              1/965(A) Vishal Khand 1, Gomti Nagar, Lucknow - 226010
            </p>
            <p className="mb-2 font-bodyFont text-2xl my-2 hover:text-red-500 flex  lg:mb-0">
              <FaPhoneSquareAlt className="text-2xl mt-2 mr-2" />
              +91 123 456 7890
            </p>
            <p className="mb-2 font-bodyFont my-5 text-2xl flex hover:text-red-500 lg:mb-0">
